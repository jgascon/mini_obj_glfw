/*
    Simple demo of a mini bear with obj loader.
...
void init() {
    global_mesh = load_obj("../models/mini_bear.obj");
    //global_mesh = load_obj("../models/sphere.obj");
    //global_mesh = load_obj("../models/triangle.obj");
...
int main(void) {
    ...
    GLuint diffuseMap = loadTexture("../images/mini_bear.png");
    error_gl = glGetError();
    if (error_gl != GL_NO_ERROR)
